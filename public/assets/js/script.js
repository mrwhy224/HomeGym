(function ($) {
	...
	// --- اصلاح اصلی برای کپی کردن منوها ---
	if ($(".main-menu__list").length && $(".mobile-nav__container").length) {
		let mobileNavContainer = document.querySelector(".mobile-nav__container");
		let allMenus = document.querySelectorAll(".main-menu__list");
		let navContent = "";

		// تمام لیست‌های منو (هم اصلی و هم زبان‌ها) را پیدا کرده و به هم می‌چسباند
		allMenus.forEach(menu => {
			navContent += menu.outerHTML;
		});
