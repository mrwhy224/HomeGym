...
@php
    ...
    $subtitle = 'Checkout';
@endphp
@section('title', ' Checkout || Fistudy || Fistudy Laravel Template ')
@section('content')
                    ...
                    <div class="col-lg-6">
                        <div class="checkout__payment">
                            ...
                            <div class="checkout__payment__item">
                                <h3 class="checkout__payment__title">Paypal payment <img src="{{ asset('assets/images/shop/paypal-1.jpg') }}" alt=""></h3>
                                <div class="checkout__payment__content">
                                    Make your payment directly into our bank account. Please
                                    use your Order ID as the payment reference. Your order
                                    wont be shipped until the funds have cleared.
                        ...
                        <div class="text-right d-flex justify-content-end">
                            <a class="thm-btn" href={{ url('checkout') }}> <span class="icon-angles-right"></span> Place
                                your
                                order</a>
                        </div><!-- /.text-right -->
