...
@endphp
@section('title', ' Testimonials Carousel || Fistudy || Fistudy Laravel Template ')
@section('content')
                    ...
                    <div class="testimonial-three__single">
                        ...
                        <div class="testimonial-three__client-info">
                            ...
                            <div class="testimonial-three__client-content">
                                <h4 class="testimonial-three__client-name"><a href={{ url('testimonials') }}>Mitchel
                                        Watson</a></h4>
                ...
                <div class="item">
                    <div class="testimonial-three__single">
                        ...
                        <div class="testimonial-three__client-info">
                            ...
                            <div class="testimonial-three__client-content">
                                <h4 class="testimonial-three__client-name"><a href={{ url('testimonials') }}>Jessica
                                        Brown</a></h4>
                                <p class="testimonial-three__client-sub-title">UI/UX Design</p>
                            </div>
                        </div>
                ...
                <div class="item">
                    <div class="testimonial-three__single">
                        ...
                        <div class="testimonial-three__client-info">
                            ...
                            <div class="testimonial-three__client-content">
                                <h4 class="testimonial-three__client-name"><a href={{ url('testimonials') }}>Asle Rose</a>
                                </h4>
                                <p class="testimonial-three__client-sub-title">UI/UX Design</p>
                            </div>
                        </div>
                ...
                <div class="item">
                    <div class="testimonial-three__single">
                        ...
                        <div class="testimonial-three__client-info">
                            ...
                            <div class="testimonial-three__client-content">
                                <h4 class="testimonial-three__client-name"><a href={{ url('testimonials') }}>Ruksana
                                        Rumi</a></h4>
                                <p class="testimonial-three__client-sub-title">UI/UX Design</p>
                            </div>
                        </div>
