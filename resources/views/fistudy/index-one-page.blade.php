...
<section class="banner-one" id="home">
    <div class="banner-one__bg-shape-1"
        style="background-image: url({{ asset('assets/images/shapes/banner-one-bg-shape-1.png') }});"></div>
    ...
    <div class="banner-one__icon-3 float-bob-y">
        <img src="{{ asset('assets/images/icon/linke-icon.png') }}" alt="">
    </div>
            ...
            <div class="col-xl-6">
                <div class="banner-one__left">
                    <div class="banner-one__title-box">
                        ...
                        <h2 class="banner-one__title">Our Online Class <br>
                            <span class="banner-one__title-clr-1">Will grow</span>
                            <span class="banner-one__title-clr-2">Your <br> Creativity</span>
                        </h2>
                    </div>
                    <p class="banner-one__text">Convenience of online education, allowing learners to acquire
                        new <br>
                ...
                <div class="banner-one__right">
                    <div class="banner-one__img-box">
                        <div class="banner-one__img">
                            <img src="{{ asset('assets/images/resources/banner-two-img-1.png') }}" alt="">
                            ...
                            <div class="banner-one__udemy-review">
                                <div class="banner-one__udemy-review-img">
                                    <img src="{{ asset('assets/images/resources/banner-one-udemy-review-img.jpg') }}" alt="">
                                </div>
                                <div class="banner-one__udemy-review-logo">
                                    <img src="{{ asset('assets/images/resources/banner-one-udemy-review-logo.png') }}" alt="">
                                </div>
        ...
        <ul class="category-one__brand-list list-unstyled">
            <li>
                <div class="category-one__brand">
                    <img src="{{ asset('assets/images/brand/category-one-brand-1-1.png') }}" alt="">
                </div>
            </li>
            <li>
                <div class="category-one__brand">
                    <img src="{{ asset('assets/images/brand/category-one-brand-1-2.png') }}" alt="">
                </div>
            </li>
            <li>
                <div class="category-one__brand">
                    <img src="{{ asset('assets/images/brand/category-one-brand-1-3.png') }}" alt="">
                </div>
            </li>
            <li>
                <div class="category-one__brand">
                    <img src="{{ asset('assets/images/brand/category-one-brand-1-4.png') }}" alt="">
                </div>
            </li>
        </ul>
    </div>
                            ...
                            <div class="category-one__count-and-arrow">
                                <div class="category-one__count-box">
                                    ...
                                    <div class="category-one__count-content">
                                        <h3><a href={{ url('course-details') }}>tech & Programing</a></h3>
                                        <p>10 Course</p>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class="category-one__count-and-arrow">
                                <div class="category-one__count-box">
                                    <div class="category-one__count"></div>
                                    <div class="category-one__count-content">
                                        <h3><a href={{ url('course-details') }}>Art & design</a></h3>
                                        <p>50 Course</p>
                                    </div>
                                </div>
                                <div class="category-one__count-arrow">
                        ...
                        <li>
                            <div class="category-one__count-and-arrow">
                                <div class="category-one__count-box">
                                    <div class="category-one__count"></div>
                                    <div class="category-one__count-content">
                                        <h3><a href={{ url('course-details') }}>Online marketing</a></h3>
                                        <p>12 Course</p>
                                    </div>
                                </div>
                                <div class="category-one__count-arrow">
            ...
            <div class="col-xl-6 col-lg-5 wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
                <div class="category-one__right">
                    <div class="category-one__img">
                        <img src="{{ asset('assets/images/resources/category-one-img-1.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Courses One Start -->
<section class="courses-one" id="course">
    <div class="container">
    ...
    <div class="container">
        <div class="newsletter-one__inner">
            <div class="newsletter-one__bg-shape"
                style="background-image: url('{{ asset('assets/images/shapes/newsletter-one-bg-shape.png') }}');"></div>
            ...
            <div class="newsletter-one__shape-2 img-bounce">
                <img src="{{ asset('assets/images/shapes/newsletter-one-shape-2.png') }}" alt="">
            </div>
                ...
                <div class="video-one__video-link">
                    <a href="https://www.youtube.com/watch?v=Get7rqXYrbQ" class="video-popup">
                        <div class="video-one__video-shape-1">
                            <img src="{{ asset('assets/images/shapes/video-one-video-shape-1.png') }}" alt="">
                        </div>
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="contact-three__right">
                    <div class="section-title-two text-left sec-title-animation animation-style1">
                        ...
                        <h2 class="section-title-two__title title-animation">We’re Here to Help and Ready to
                            Hear from You</span>
                        </h2>
                    </div>
                    <form class="contact-form-validated contact-three__form" action="assets/inc/sendemail.php"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6">
                                ...
                                <div class="contact-three__input-box">
                                    <input type="email" name="email" placeholder="jhon@doman.com" required="">
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <h4 class="contact-three__input-title">Subject *</h4>
                                <div class="contact-three__input-box">
                                    <input type="text" name="Phone" placeholder="write about your enquiry"
                                        required="">
                                </div>
                            </div>
                            <div class="col-xl-12">
                                ...
                                <div class="contact-three__btn-box">
                                    <button type="submit" class="thm-btn-two contact-three__btn"><span>Submit
                                            Review</span><i class="icon-angles-right"></i></button>
                                </div>
                            </div>
                        </div>
                    </form>
